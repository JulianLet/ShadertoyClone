...
ShaderProgramSource Shader::ParseShader(const std::string& filepath)
{
    ...
    {
        NONE = -1, VERTEX = 0, FRAGMENT = 1 //index 0 and 1 is used to fll the string stram array
    };
...
void Shader::SetUniform3f(const std::string& name, float v0, float v1, float v3)
{
    GLCall(glUniform3f(GetUniformLocation(name), v0, v1, v3));
}
